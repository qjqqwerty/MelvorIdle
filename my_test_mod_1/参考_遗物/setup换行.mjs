...
function u(i)
{
    ...
    {
        return this.game.currentGamemode.allowAncientRelicDrops = !!s.get("enable-mod"), this.game.currentGamemode.allowAncientRelicDrops ? this.numberOfRelicsFound >= 5 : !1
    });
    ...
    {
        return this.id !== "Ancient Relics Mod" || game.currentGamemode.localID !== "AncientRelics" ? [e] : (e && (e.onClick = () => Swal.fire(
        {
            icon: "error",
            title: "Mod Disabled",
...
%cAncient Relics %s%c
%cLesser Relics %s%c`, c.version, "color: green; font-weight: bold;", game.characterName, "", "color: #d3ba7c;", s.get("enable-mod") ? "Enabled" : "Disabled", "", "color: #e41e7f;", e ? "Enabled" : "Disabled", ""), i.patch(Player, "addAncientRelicModifiers").replace(function(n)
        {
